...
namespace W.TEST
{
    public partial class frmLamBai : Form
    {
        ...
        {
            int a = Int32.Parse(milisec_label.Text);//miligiay
            int b = Int32.Parse(sec_label.Text);//giay
            int c = Int32.Parse(minute_label.Text);//phut
            ...
            if (a < 10)
            {
                milisec_label.Text = "0" + a;
            }
            else
            {
                milisec_label.Text = a + "";
            }
            if (b < 10)
            {
                sec_label.Text = "0" + b;
            ...
            {
                timer1.Stop();
                MessageBox.Show("Het Gio Lam Bai");
